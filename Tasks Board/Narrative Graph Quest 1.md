...
2. **Раджа** — его старый друг, ныне высокомерный правитель.
...
## Initial State Брахмана (`Node brahman_0`)

**Условие** 
игрок еще не встречал Раджи.
...
После A1 любые последующие сцены с Раджой должны быть без его initial state (B1) и переходят к B2.

---

## `Node brahman_1` — Брахман объясняет причину разрыва

**Условие** посещена `Node brahman_0`, Раджа еще не встречен.
...
**Последствия:**  
Открывает путь к A3 или к встрече с Раджой (B2).

---

## Вершина A3 — Брахман сомневается

**Условие** посещена A1, Раджа еще не встречен.
...
**Последствия:**  
Переход к встрече с Раджой (B2).

---

## Вершина A4 — Брахман после встречи игрока с Раджой

**Условие** игрок уже посетил Раджи (любая сцена из B2 или B3).
...
**Последствия:**  
Возникает новое условие для ветки Раджи — Раджа становится менее резким в ответах (открывает B3-Aware).
...
**Последствия:**  
Раджа получает более мягкую, но все еще высокомерную линию в B3-Aware.
...
**Последствия:**  
Открывает альтернативную эмоциональную ветку Раджи в B3-Confront.
...
## Вершина B1 — Initial State Раджи

**Условие** игрок еще не встречал Брахмана.
...
3. «Я встретил странствующего мудреца…» → если игрок еще не встречал Брахмана, ветка закрыта; если встречал — открывает B3-Aware.
    

---

## Вершина B2 — Раджа отвергает прошлое

**Условие** игрок встретил Раджи до Брахмана или пришел к нему из A1–A3.
...
**Последствия:**  
Если игрок еще не встречал Брахмана — активируется A4 при встрече.  
Если встречал — активируется A5/A6/A7 в зависимости от его выбора.

---

## Вершина B3-Aware — Раджа знает, что игрок был у Брахмана

**Условие** игрок уже встретил Брахмана и провел с ним беседу (A4).

**Сцена**  
Раджа говорит без привычного высокомерия:  
...
## Вершина B3-Confront — Раджа в состоянии защиты
...
## Вершина B5 — Раджа оправдывается
...
## Вершина B6 — Раджа раскрывает мотив
...
**Сцена**  
— Тогда пусть он живет в своих воспоминаниях. В моем мире для него места нет.

**Последствия:**  
Финальная ветка: Раджа отказывается от примирения.
...
Брахман и Раджа, каждый через слова игрока, понимают взаимные заблуждения.  
...
Если нужно, могу оформить это в табличный формат, превратить в JSON-структуру для движка или расширить до трех персонажей и встроенного меж-NPC диалога.
